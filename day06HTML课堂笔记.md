	...
	3. 标签学习：
		...
		2. 文本标签：和文本有关的标签
			...
			* 属性定义：
				...
				* width：
					1. 数值：width='20' ,数值的单位，默认是 px(像素)	【【【【【【默认是px，  所以px可以不写
					2. 数值%：占比相对于父元素的比例
...
​			* img：展示图片
​				* 属性：
​					* src：指定图片的位置        路径用正斜杠或者反斜杠都可以，但通常用正斜杠
​	
			* 代码：
				 <!--展示一张图片 img-->
		...
		5. 链接标签：
			* a:定义一个超链接
				* 属性：
					* href：指定访问资源的URL(统一资源定位符)    【【href属性指定空字符串时为重新跳转本页面，如果不想跳转则指定“javascript:void(0);”     href=''则表示重新刷新页面    href='#'表示回到页面顶端，但不重新刷页面
					* target：指定打开资源的方式
						* _self:默认值，在当前页面打开
						* _blank：在空白页面打开
		...
		8. 表格标签：
			...
			* tr：定义行
				* bgcolor：背景色
				* align：对齐方式
			* td：定义单元格                                                                                     //colspan，rowspan例子
				* colspan ：合并列【【【这两个属性是td标签的                                                     <table border="10">                                                        
				* rowspan ：合并行	                                                                               <tr>                                                        
			* th：定义表头单元格	                                                                                 <th>1</th>                                                        
			* <caption>：表格标题	                                                                                 <th>2</th>                                                        
			* <thead>：表示表格的头部分   增强可读性 以后和css一起使用  控制样式更方便	                         	  <td>3</td>                                                        
			* <tbody>：表示表格的体部分	                                                                           </tr>                                                        
			* <tfoot>：表示表格的脚部分	                                                                           <tr>                                                        
...
## 案例：旅游网站首页	                                                                                         	                                                          
	1. 确定使用table来完成布局		                                                                               </tr>                                                        
	2. 如果某一行只有一个单元格，则使用<tr><td></td></tr>	                                                       <tr>                                                        
	3. 如果某一行有多个单元格，则使用	                                                                             <td >February</td>                                                        
		<tr>	                                                                                                     <td>$80</td>                                                        
			<td>	                                                                                             	  <td rowspan="2">100</td>                                                        
				<table></table>	                                                                                   </tr>                                                        
			</td>	                                                                                             	<tr>                                                        
		</tr>	                                                                                                     <td >a</td>                                                        
	                                                                                                                 <td>100</td>                                                        
